...
from trips.views import home, attraction, accomodation, restaurant, post_detail, post_new, post_delete, post_edit, register, area, like_post, post_serialized_view, post_new_comment, tag, post_nearby
...
urlpatterns = [
    ...
    re_path(r'^post/post_new_comment/(?P<post_id>[0-9]+)/$',
            post_new_comment, name='post_new_comment'),
    ...
    re_path(r'^tag/(?P<pk>\d+)/$', tag, name="tag"),
    re_path(r'^nearby/(?P<pk>\d+)/$', post_nearby, name="post_nearby"),
